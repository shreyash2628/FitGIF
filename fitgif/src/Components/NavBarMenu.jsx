...
const NavBarMenu = ({setShowMenu}) => {
  ...
  return (
    <div>
       ...
       <Link to={'/home'}><h1 onClick={handleOnClickOfLink} className="text-lg font-bold  pr-3">Home</h1> </Link>
       <Link to={'/exerciseDetails'}><h1 onClick={handleOnClickOfLink} className="text-lg font-bold  pr-3 ">Exercises</h1> </Link>
